...
export class CSharpenVSCodeExtensionSettings extends VSCodeExtensionSettings {
 ...
 // not read from extension setting but from editor settings
    ...
    public static get defaultAutoGeneratedPatterns() {
        return [
            "^[ \\t]*/{2,3}[^\\r\\n]*<auto-generated\\b"
        ];
    }

    public static get defaultCodingStyles() {
        return new CodingStyles({});
    }

    public static get defaultDoNotRemoveThesePackageReferences() {
        return [
            "coverlet.collector",
            "coverlet.msbuild",
            "Microsoft.NET.Sdk",
    ...
    public static get defaultFileFilters() {
        return [
            {
                "confirmOnDeny": false,
    ...
    public static get defaultQuickFixFilters() {
        return [
            "^Fix All",
    ...
    public static get defaultSymbolRenaming() {
        return [] as SymbolRename[];
    }

    public static get regionalizableGenericInterfaceImplementations() {
        return [
            "IList",
            "ICollection",
            "IEnumerable",
    ...
    public static get regionalizableInterfaceImplementations() {
        return [
            "IDisposable",
            "IAsyncDisposable",
